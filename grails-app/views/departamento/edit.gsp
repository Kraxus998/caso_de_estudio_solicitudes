...
<%@ page import="solicitudes.Departamento" %>
<html>
    <head>
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="nombre"><g:message code="departamento.nombre.label" default="Nombre" /></label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="local"><g:message code="departamento.local.label" default="Local" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: departamentoInstance, field: 'local', 'errors')}">
                                    
<ul>
<g:each in="${departamentoInstance?.local?}" var="l">
    <li><g:link controller="local" action="show" id="${l.id}">${l?.encodeAsHTML()}</g:link></li>
</g:each>
</ul>
<g:link controller="local" action="create" params="['departamento.id': departamentoInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'local.label', default: 'Local')])}</g:link>
